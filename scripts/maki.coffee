...
module.exports = (robot) ->
  ...
  robot.hear /(sex|SEX|エロ)/i, (msg) ->
    ...
    msg.send msg.random [
      ...
      "しっかりしなさいよ、もう",
      "ええやん💖",
      "せっかくなんだし二人で何処かに行きたいわね",
      "24日の夜におとなしく寝てたら、枕元に私がいるかもよ💝",
      "はあ！？ なんで私が！",
      "べ、別にいいけど‼︎",
      "ちょっと、何騒いでるのよ。外まで聞こえてるんだけど。",
      "脱いで♡",
      "いまからお風呂よ http://38.media.tumblr.com/1e87f98afe9d6e707ad73246af238b18/tumblr_n785rffmmT1s5f9ado1_500.gif",
      "どこへでも💝",
      "また欲張りなお願いしてたんでしょ〜",
      "やんやんっ♡♡",
      "ないやん",
  ...
  robot.hear /(あすか|飛鳥)のちん(ちん|こ|ぽ)/i, (msg) ->
    sleep 5000
    msg.send msg.random [
      "とてもちっちゃい💝"
    ]
